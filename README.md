...
| kube-proxy replacement, Gateway, L2 실습 `06-08`, `15` | CPU 6 cores, RAM 12 GiB, disk 40 GiB 이상 | `cilium-study-kpr`를 함께 유지하는 경우 |
| Advanced 선택 실습 `12-19` | CPU 8 cores, RAM 16 GiB, disk 50 GiB 이상 | Cluster Mesh, BGP, Egress, Encryption, Gateway Advanced, Mutual Auth, Policy/Host Firewall 클러스터를 장별로 생성/삭제하는 기준 |
